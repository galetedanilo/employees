...
public class EmployeeControllerIT {
	...
	public void insertShouldReturn403WhenOperatorLogged() throws Exception {
		...
		EmployeeDTO dto = new EmployeeDTO(null, "Joaquim", "Silva", "joaquim@gmail.com", 1L);
	...
	public void insertShouldInsertResourceWhenAdminLoggedAndCorrectData() throws Exception {
		...
		result.andExpect(jsonPath("$.firstName").value("Joaquim"));
	...
	public void insertShouldReturn422WhenAdminLoggedAndBlankName() throws Exception {
		...
		EmployeeDTO dto = new EmployeeDTO(null, "   ", "Silva", "joaquim@gmail.com", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndInvalidEmail() throws Exception {
		...
		EmployeeDTO dto = new EmployeeDTO(null, "Joaquim", "Silva", "joaquim@", 1L);
		String jsonBody = objectMapper.writeValueAsString(dto);
	...
	public void insertShouldReturn422WhenAdminLoggedAndNullDepartment() throws Exception {
		...
		EmployeeDTO dto = new EmployeeDTO(null, "Joaquim", "Silva", "joaquim@gmail.com", null);
		String jsonBody = objectMapper.writeValueAsString(dto);
